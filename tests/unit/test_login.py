...
def test_login_invalid_email(client):
    ...
    # The requirement says we should show an error message and we should be redirected or stay at index.
    # Looking at similar flask patterns, typically they redirect back to index, or render index with error.
